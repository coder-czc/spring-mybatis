            ...
            $.messager.confirm('确认', '您确认想要删除记录吗？', function (r) {
                ...
                if (r) { //若确认要删除，则采用异步方式把要删除的数据行对应的id串传送给后台进行处理
                    ...
                    $.ajax({
                        ...
                        url: "../publisher/deleteall",//后台处理程序
...
function initpublisher() {
    ...
    /*下面采用jquery easyui的datagrie控制进行显示出版社的列表*/
