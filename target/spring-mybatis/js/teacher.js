function teacherupdate(row){
    ...
    var str = ' <form id="ff" method="post">\n' +
        ...
        '                <td><input type="text" id="departId" name="departId" /></td>\n' +
        ...
        '                <td><input type="text" id="utype" name="utype" /></td>\n' +
...
function initteacher() {
    ...
    /*下面采用jquery easyui的datagrie控制进行显示老师的列表*/
