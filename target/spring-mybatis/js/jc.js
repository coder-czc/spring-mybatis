function jcupdate(row){
    ...
    var str = ' <form id="ff" method="post">\n' +
        ...
        '                <td><input type="text" id="publisherId" name="publisherId" /> </td>\n' +
...
function initjc() {
    ...
    /*下面采用jquery easyui的datagrie控制进行显示教材的列表*/
