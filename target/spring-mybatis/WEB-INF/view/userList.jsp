    ...
    <script type="text/javascript">
        ...
        function del(rows) {
            ...
            $.ajax( //采用异步通讯向后台的json控制器的requestJson方法发送json数据

                {
                    ...
                    url:"${pageContext.request.contextPath}/users/deluser", //控制器
            ...
            $('#dd').dialog({
                ...
                buttons: [{
                    ...
                    handler: function () {
                        ...
                        var user = {};
                        user.id=$('#dg').datagrid('getSelected').id;
                        ...
                        $.ajax( //采用异步通讯向后台的json控制器的requestJson方法发送json数据

                            {
                                ...
                                url: "${pageContext.request.contextPath}/users/updateuser", //控制器
                    ...
                    handler: function () {
                        ...
                        $.ajax( //采用异步通讯向后台的json控制器的requestJson方法发送json数据

                            {
                                ...
                                url: "${pageContext.request.contextPath}/users/adduser", //控制器
        ...
        $(function () {
            ...
            $('#dg').datagrid({
                ...
                url: '${pageContext.request.contextPath}/users/getUserInfo',
